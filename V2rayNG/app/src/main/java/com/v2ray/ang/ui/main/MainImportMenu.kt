...
fun ImportMenuContent(
    ...
    DropdownMenuItem(
        text = { Text(stringResource(R.string.menu_item_import_config_manually_private_socks)) },
        onClick = { onAction(MainAction.ImportManually(EConfigType.PRIVATE_SOCKS.value)) }
    )
    DropdownMenuItem(
