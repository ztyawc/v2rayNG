...
class ServerUiState(
    ...
    var cmccProtocol by mutableStateOf(cmccProtocol)
    var httpHeadersText by mutableStateOf(httpHeadersText)
    ...
    fun toProfileItem(initialConfig: ProfileItem): ProfileItem {
        ...
        val isHttp = configType == EConfigType.HTTP
        ...
        return initialConfig.copy(
            ...
            cmccProtocol = if (isPrivateSocks) {
                CmccSocksFmt.normalizeCmccProtocol(cmccProtocol)
            } else {
                null
            },
            httpHeaders = if (isHttp) {
    ...
    companion object {
        fun fromProfileItem(
            ...
            ServerUiState(
                ...
                cmccProtocol = CmccSocksFmt.normalizeCmccProtocol(initialConfig.cmccProtocol)
                    ?: CmccSocksFmt.AUTH_80,
                httpHeadersText = HttpHeaderParser.format(initialConfig.httpHeaders),
